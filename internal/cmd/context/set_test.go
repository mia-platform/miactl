...
func TestUpdateContextMap(t *testing.T) {
	...
	opts := &clioptions.CLIOptions{APIBaseURL: "https://url", ProjectID: "project1", CompanyID: "company1"}
	...
	opts = &clioptions.CLIOptions{APIBaseURL: "https://url2", ProjectID: "project2", CompanyID: "company2"}
