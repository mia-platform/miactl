...
func TestUpdateContextMap(t *testing.T) {
	...
	opts := &clioptions.RootOptions{APIBaseURL: "https://url", ProjectID: "project1", CompanyID: "company1"}
	...
	actualContexts := updateContextMap(nil, opts, "context1")
	require.Equal(t, expectedContexts, actualContexts)

	// Test updating the existing context
	opts = &clioptions.RootOptions{APIBaseURL: "https://url2", ProjectID: "project2", CompanyID: "company2"}
