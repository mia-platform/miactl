...
> *Note*: If you prefer not to use browser-based login, you can alternatively [setup a service account](https://docs.mia-platform.eu/docs/products/console/identity-and-access-management/manage-service-accounts#adding-a-service-account) and use the [`miactl context auth` command](./30_commands.md#auth) to setup authentication.
