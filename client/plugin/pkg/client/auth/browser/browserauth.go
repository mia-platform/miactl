...
func providerIDForApplication(ctx context.Context, appID string, client rest.Interface) (string, error) {
	response, err := client.
		Get().
...
func parseJWTResponse(jwtResponse *rest.Response) (*oauth2.Token, error) {
